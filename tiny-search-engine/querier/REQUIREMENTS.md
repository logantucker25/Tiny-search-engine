...
A *space* is any character for which `isspace()` returns true (see `man isspace`).
...
> See the [unit](https://www.cs.dartmouth.edu/~tjp/cs50/labs/lab6/querier-expressions) noting how this syntax is similar to another grammar you know well: arithmetic.
>
>```
